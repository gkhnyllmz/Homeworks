...
# I added iaddq to be able to directly increasing and decreasing register values.
# By this, I will not need to store constants in register and irmovq instruction to do this.
# So, I will decrease total instruction number.
#
# ------------ FETCH ------------
#	icode:ifun <- M1[PC]
#	rA:rB <- M1[PC+1] (rA <- 0xf)
#	valC <- M8[PC+2]
#	valP <- PC+10
#
# ------------ DECODE ------------
